  ...
  return (
    <div className="app">
      ...
      <section className="summary" aria-label="汇总">
        ...
        <div>
          <span className="label">结果合计</span>
      ...
      {persistError && (
        <div className="banner warn">本地保存失败，请检查浏览器存储权限。</div>
      )}
      {validateBanner && (
        <div
      ...
      <main className="list">
        {sortedPlayers.length === 0 ? (
          ...
          <div className="player-table" role="table" aria-label="人员记分列表">
        ...
        >
          ...
          {!compactBar && (
            <>
              ...
              <button type="button" className="btn ghost" onClick={openShare}>
                分享
              </button>
              <button
                type="button"
